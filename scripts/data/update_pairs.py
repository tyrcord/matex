...
# Base URL
base_url = "https://raw.githubusercontent.com/tyrcord/tbase/master/financial/pairs/"

# Output filename
output_filename = "pairs.json"

# Endpoints
endpoints = ["commodities.json", "cryptos.json", "exotics.json",
             "indexes.json", "majors.json", "metadata.json", "minors.json"]
